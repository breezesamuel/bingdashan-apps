...
## purpose
Automated map for i18n tasks. Execute the map step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply map to each matching i18n app
3. write results under C:/bingdashan/skills-out/map-i18n-226
