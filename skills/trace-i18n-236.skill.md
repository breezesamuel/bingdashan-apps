...
## purpose
Automated trace for i18n tasks. Execute the trace step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply trace to each matching i18n app
3. write results under C:/bingdashan/skills-out/trace-i18n-236
