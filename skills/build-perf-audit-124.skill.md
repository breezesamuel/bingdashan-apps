...
## purpose
Automated build for perf-audit tasks. Execute the build step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply build to each matching perf-audit app
3. write results under C:/bingdashan/skills-out/build-perf-audit-124
