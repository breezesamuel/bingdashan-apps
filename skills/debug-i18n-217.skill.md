...
## purpose
Automated debug for i18n tasks. Execute the debug step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply debug to each matching i18n app
3. write results under C:/bingdashan/skills-out/debug-i18n-217
