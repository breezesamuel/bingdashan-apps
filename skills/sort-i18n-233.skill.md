...
## purpose
Automated sort for i18n tasks. Execute the sort step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply sort to each matching i18n app
3. write results under C:/bingdashan/skills-out/sort-i18n-233
