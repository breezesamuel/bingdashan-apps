...
## purpose
Automated fix for i18n tasks. Execute the fix step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply fix to each matching i18n app
3. write results under C:/bingdashan/skills-out/fix-i18n-222
