...
## purpose
Automated scan for i18n tasks. Execute the scan step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply scan to each matching i18n app
3. write results under C:/bingdashan/skills-out/scan-i18n-231
