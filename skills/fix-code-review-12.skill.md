...
## purpose
Automated fix for code-review tasks. Execute the fix step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply fix to each matching code-review app
3. write results under C:/bingdashan/skills-out/fix-code-review-12
