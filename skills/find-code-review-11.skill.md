...
## purpose
Automated find for code-review tasks. Execute the find step, output ASCII-only results, log each action to disk, and report verifiable evidence (file paths, byte counts, http status codes).
...
2. apply find to each matching code-review app
3. write results under C:/bingdashan/skills-out/find-code-review-11
